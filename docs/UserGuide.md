...
| **Add Exercise to Programme**             | Adds an exercise to a specific day in a programme                         | `prog edit [/p PROG_INDEX] /d DAY_INDEX /a /n EXERCISE_NAME /w WEIGHT /r REPS /s SETS /c CALORIES` | `prog edit /p 1 /d 1 /a /n Push_Up /w 30 /r 15 /s 3 /c 100`               |
| **Delete Exercise from Programme**        | Deletes an exercise from a specific day in a programme                    | `prog edit [/p PROG_INDEX] /d DAY_INDEX /x EXERCISE_INDEX`                                         | `prog edit /p 1 /d 1 /x 1`                                                |
| **Update Exercise in Programme**          | Updates an exercise in a specific day of a programme                      | `prog edit [/p PROG_INDEX] /d DAY_INDEX /u EXERCISE_INDEX [args]`                                  | `prog edit /p 1 /d 1 /u 1 /w 30 /r 12`                                    |
