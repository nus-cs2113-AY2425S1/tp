...
| v1.0    | user                  | receive alerts about upcoming deadlines        | ensure I don't miss important deadlines                 |
| v1.0    | user                  | sort internships by required skills            | focus on internships that match my skill set            |
