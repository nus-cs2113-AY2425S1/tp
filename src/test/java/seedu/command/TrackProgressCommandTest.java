...
public class TrackProgressCommandTest {
    ...
    private TrackProgressCommand trackProgressCommand;

    @BeforeEach
    public void setUp() {
        TransactionList transactionList = new TransactionList();
        budgetTracker = new BudgetTracker(transactionList);
        trackProgressCommand = new TrackProgressCommand(budgetTracker);
    }
    ...
    public void execute_trackProgressAllValidFields_success() {
        ...
        trackProgressCommand.setArguments(Map.of("m/", "2024-11"));
    ...
    public void execute_trackProgressFutureMonth_failure() {
        ...
        trackProgressCommand.setArguments(Map.of("m/", futureMonth.toString()));
        List<String> result = trackProgressCommand.execute();
