...
public class ProgrammeListTest {
    ...
    public void setUp() {
        ...
        // Stub methods for mock programmes to return names and day objects
    ...
    @Test
    void testToString() {
        // Start the first programme to mark it as active
        programmeList.startProgramme(0);

        String programmeListString = programmeList.toString();

        // Adjust expected string format to match the output generated by ProgrammeList#toString
