...
class CreateDayCommandTest {
    ...
    private Day day;
    private CreateDayCommand command;
    ...
    void execute_handlesNonexistentProgrammeIdGracefully() {
        CreateDayCommand invalidCommand = new CreateDayCommand(OUT_OF_RANGE_PROGRAMME_ID, day);
