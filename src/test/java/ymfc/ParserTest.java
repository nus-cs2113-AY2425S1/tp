...
import static ymfc.Parser.parseCommand;

class ParserTest {

    static Stream<Arguments> parseCommand_addRecipeCommand_success_data() {
        return Stream.of(
                arguments( // Universal test #1
                        ...
                        ), "add n/Ramen Eggs i/eggs i/soya sauce i/water s1/boil eggs for 6.5 min s2/cool eggs in ice bath"
                ),

                arguments( // Universal test #2
                        new Recipe("Grilled Cheese Sandwhich",
                                new ArrayList<>(Arrays.asList("bread", "cheese slice", "butter")),
                                new ArrayList<>(Arrays.asList("heat pan with butter", "grill bread on pan, and add cheese on top", "remove from grill after 3 minutes"))
    ...
    @MethodSource("parseCommand_addRecipeCommand_success_data")
    ...
    @ValueSource(strings = {
            ...
            "add n/  Porridge  i/ oats  i/milk s1 / cook oats",                             // Whitespace before or after slashes
