...
public class WalkAndRunCalculator extends Calculator {
    ...
    /**
     * Calculates the points based on gender, age, and time taken for the shuttle run (in seconds).
     *
     * @param gender the gender of the individual
     * @param age the age of the individual
     * @param reps the time taken to complete the shuttle run (in seconds)
