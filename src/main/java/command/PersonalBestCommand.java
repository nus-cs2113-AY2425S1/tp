...
public class PersonalBestCommand extends Command {
    public static final String COMMAND_WORD = "personalbests";
    ...
    public void execute(Ui ui, ProgrammeList pList, History history) {
        ...
        if (exerciseName != null && !exerciseName.isEmpty()) {
            String personalBest = history.getPersonalBestForExercise(exerciseName);  // Call method for specific exercise
            ui.showMsg(personalBest);
        } else {
            ...
            if (personalBests.isEmpty()) {
                ui.showMsg("No personal bests found.");
            } else {
                ...
                ui.showMsg(bestsMessage.toString());
            }
        }
    }
}
